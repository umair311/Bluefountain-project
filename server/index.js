...
// });
        ...
        app.post('/work',upload.single('file'), function(request, response) {
            ...
            mysqlconnection.query('INSERT INTO work(name,des,img) VALUES(?,?,?)', [name,des,file], function(error, results, fields) {
        ...
        app.get('/work/:id', function(request, response) {
            ...
            mysqlconnection.query('SELECT *FROM work where id =?',[request.params.id], function(error, results, fields) {
        ...
        app.put('/work/:id',upload.single('file'), function(request, response) {
...
var file = request.file.filename;
            ...
            mysqlconnection.query('UPDATE work SET name=?, des=? , img=? WHERE id=?',[name,des,file,request.params.id], function(error, results, fields) {
        ...
        app.delete('/work/:id', function(request, response) {





            mysqlconnection.query('DELETE FROM work where id =?',[request.params.id], function(error, results, fields) {
        ...
        app.post('/insight',upload.single('file'),(req,res)=>{
            ...
            // insert to db
            mysqlconnection.query("INSERT INTO insight(hed,meta,img1,hed1,des1,hed2,des2,hed3,des3,hed4,des4,hed5,des5,hed6,des6,hed7,des7,hed8,des8,hed9,des9,hed10,des10) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [hed,meta,file,hed1,des1,hed2,des2,hed3,des3,hed4,des4,hed5,des5,hed6,des6,hed7,des7,hed8,des8,hed9 ,des9 ,hed10 ,des10 ], function (error, results, fields) {
                if (error) throw error;
            ...
            app.get('/insight', function(request, response) {


  
	
	
                mysqlconnection.query('SELECT *FROM insight', function(error, results, fields) {
            ...
            app.get('/insight/:id', function(request, response) {


  
	
	
                mysqlconnection.query('SELECT *FROM insight WHERE id=?',[request.params.id], function(error, results, fields) {
            ...
            app.delete('/insight/:id', function(request, response) {


  
	
	
                mysqlconnection.query('DELETE FROM insight WHERE id=?',[request.params.id], function(error, results, fields) {
        ...
        app.put('/insight/:id',upload.single('file'),(req,res)=>{
            ...
            // insert to db
            mysqlconnection.query("Update insight SET hed=?,meta=?,img1=?,hed1=?,des1=?,hed2=?,des2=?,hed3=?,des3=?,hed4=?,des4=?,hed5=?,des5=?,hed6=?,des6=?,hed7=?,des7=?,hed8=?,des8=?,hed9=?,des9=?,hed10=?,des10=? WHERE id=?", [hed,meta,file,hed1,des1,hed2,des2,hed3,des3,hed4,des4,hed5,des5,hed6,des6,hed7,des7,hed8,des8,hed9 ,des9 ,hed10 ,des10,req.params.id ], function (error, results, fields) {
                if (error) throw error;
                return res.send({ error: false, data: results, message: 'Data successfully added' });
            });
